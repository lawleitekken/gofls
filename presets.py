...
class Presets(object):
    ...
    NO_MEDIA = "Requested movie: <b>{}</b>\n\n<b> Sorry, No Movie Related to the Given Word \n 🥺 Please Follow Below points \n\n" \
               "⭕️ Please Check <a href='https://www.google.com/search?q={}'> Spelling in Google</a> And\n" \
               "⭕️ Just Type The MovieName Year Language Ex: <b>SpiderMan 2021 Telugu</b>\n" \
