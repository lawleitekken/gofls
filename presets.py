...
class Presets(object):
    ...
    NO_MEDIA = "𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐞𝐝 𝐦𝐨𝐯𝐢𝐞: <b>{}</b>\n\n𝐒𝐨𝐫𝐫𝐲, 𝐍𝐨 𝐌𝐨𝐯𝐢𝐞 𝐑𝐞𝐥𝐚𝐭𝐞𝐝 𝐭𝐨 𝐭𝐡𝐞 𝐆𝐢𝐯𝐞𝐧 𝐖𝐨𝐫𝐝 🥺 𝐏𝐥𝐞𝐚𝐬𝐞 𝐅𝐨𝐥𝐥𝐨𝐰 𝐁𝐞𝐥𝐨𝐰 𝐩𝐨𝐢𝐧𝐭𝐬 \n\n" \
               "★𝐏𝐥𝐞𝐚𝐬𝐞 𝐂𝐡𝐞𝐜𝐤 <a href='https://www.google.com/search?q={}'> 𝐒𝐩𝐞𝐥𝐥𝐢𝐧𝐠 𝐢𝐧 𝐆𝐨𝐨𝐠𝐥𝐞 </a>\n" \
               "<code>★𝐉𝐮𝐬𝐭 𝐓𝐲𝐩𝐞 𝐓𝐡𝐞 𝐌𝐨𝐯𝐢𝐞𝐍𝐚𝐦𝐞 𝐘𝐞𝐚𝐫    𝐄𝐱: <b>𝐒𝐩𝐢𝐝𝐞𝐫𝐌𝐚𝐧 𝟐𝟎𝟐𝟏 𝐓𝐞𝐥𝐮𝐠𝐮</b> \n★𝐒𝐭𝐢𝐥𝐥 𝐌𝐨𝐯𝐢𝐞 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝 𝐏𝐥𝐳 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐔𝐫 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐌𝐨𝐯𝐢𝐞 <a href='https://t.me/justwatch_movies'> 𝙃𝙚𝙧𝙚 </a></code>"
